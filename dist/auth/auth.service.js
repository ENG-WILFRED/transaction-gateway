...
let AuthService = class AuthService {
    partnerRepo;
    jwtService;
    constructor(partnerRepo, jwtService) {
        this.partnerRepo = partnerRepo;
        this.jwtService = jwtService;
    }
    async validatePartner(clientId, clientSecret) {
        const partner = await this.partnerRepo.findOne({ where: { clientId, status: integration_partner_entity_1.PartnerStatus.ACTIVE } });
        if (!partner)
